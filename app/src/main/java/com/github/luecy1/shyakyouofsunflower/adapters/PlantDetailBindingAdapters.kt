...
fun bindRenderHtml(view: TextView, desctiption: String?) {
    if (desctiption != null) {
        view.text = HtmlCompat.fromHtml(desctiption, FROM_HTML_MODE_COMPACT)
...
fun bindiWateringText(textView: TextView, wateringInterval: Int) {
